...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\n=== valueOf ===");
        Priority highPri = Priority.valueOf("HIGH");
        System.out.println("Priority.valueOf(\"HIGH\") = " + highPri);

        System.out.println("\n=== Comparare enum ===");
        System.out.println("HIGH == HIGH? " + (highPri == Priority.HIGH));
        System.out.println("HIGH == LOW? " + (highPri == Priority.LOW));
